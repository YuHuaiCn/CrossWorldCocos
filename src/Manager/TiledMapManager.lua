...
function TiledMapManager:initMap(map, layer)
	...
	for _, obj in ipairs(objects) do
		if obj._unpassable then
	    	...
	    	body:setContactTestBitmask(PhysicsMask.WALL_CONTACT_MASK)
	    	body:setCategoryBitmask(PhysicsMask.WALL_CATEGORY_MASK)
	    	body:setCollisionBitmask(PhysicsMask.WALL_COLLISION_MASK)
